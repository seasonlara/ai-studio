...
const mainBlueprints = [
  {
    ...
    copy: "主標使用商品品類或核心用途，例如「兒童安全座椅」「車用收納盒」；搭配 2-3 個可見賣點短標籤，例如「穩固支撐」「加厚座墊」「收納有序」。",
    scene: "產品置中放大，暖橙奶油色高級棚拍背景，可加入一個局部放大圓框與箭頭；主標置頂，賣點標籤分布在四周，保留手機端可讀留白。",
  },
  {
    title: "防護支撐圖",
    purpose: "把產品能提供的支撐、固定、保護或穩定感視覺化，降低買家對使用安全與穩定性的疑慮。",
    copy: "使用 3 個短標籤描述可見或合理的結構賣點，例如「背部支撐」「側邊包覆」「底部加穩」；避免寫絕對安全、碰撞保護、認證合格等未提供聲明。",
  ...
  },
  {
    ...
    copy: "選 3 個可見細節做短標籤，例如「透氣網布」「精密車線」「耐用扣具」「加厚邊線」「可愛圖案」；不同品類自動替換成對應細節。",
    scene: "三段式細節版面：左圖右字或交錯卡片，使用微距特寫、圓角圖片框、粗體繁體中文，背景為高級暖橙漸層。",
  },
  {
    title: "包裝內容圖",
